...
<?php
    ...
    if($calculo_imc >= 26 ){
        echo "Peso esta normal: " . number_format($calculo_imc, 2);
    }elseif($calculo_imc >= 26 && $calculo_imc < 30 ){
        echo "Voce esta Obeso: " . number_format($calculo_imc, 2);
    }elseif($calculo_imc >= 30){
        echo "Voce esta com Obesidade Morbida: " . number_format($calculo_imc, 2);
    }
